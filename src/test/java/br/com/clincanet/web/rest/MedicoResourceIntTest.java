...
public class MedicoResourceIntTest {
    ...
    private static final Especialidade DEFAULT_ESPECIALIDADES = Especialidade.CARDIO;
    private static final Especialidade UPDATED_ESPECIALIDADES = Especialidade.ENDOCRINOLOGIA;
    ...
    public void createMedico() throws Exception {
        ...
        assertThat(testMedico.getEspecialidades()).isEqualTo(DEFAULT_ESPECIALIDADES);
    }
    ...
    public void getAllMedicos() throws Exception {
        ...
        restMedicoMockMvc.perform(get("/api/medicos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].especialidades").value(hasItem(DEFAULT_ESPECIALIDADES.toString())));
    }
    ...
    public void getMedico() throws Exception {
        ...
        restMedicoMockMvc.perform(get("/api/medicos/{id}", medico.getId()))
            ...
            .andExpect(jsonPath("$.especialidades").value(DEFAULT_ESPECIALIDADES.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateMedico() throws Exception {
        ...
        assertThat(testMedico.getEspecialidades()).isEqualTo(UPDATED_ESPECIALIDADES);
    }
