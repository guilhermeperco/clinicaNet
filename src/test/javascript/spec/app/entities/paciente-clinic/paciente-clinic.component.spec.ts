...
import { PacienteClinicComponent } from 'app/entities/paciente-clinic/paciente-clinic.component';
...
describe('Component Tests', () => {
    describe('PacienteClinic Management Component', () => {
        let comp: PacienteClinicComponent;
        let fixture: ComponentFixture<PacienteClinicComponent>;
        let service: PacienteClinicService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ClinicaNetTestModule],
                declarations: [PacienteClinicComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PacienteClinicComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PacienteClinicComponent);
