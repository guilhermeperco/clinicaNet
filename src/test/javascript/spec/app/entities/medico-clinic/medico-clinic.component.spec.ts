...
import { MedicoClinicComponent } from 'app/entities/medico-clinic/medico-clinic.component';
...
describe('Component Tests', () => {
    describe('MedicoClinic Management Component', () => {
        let comp: MedicoClinicComponent;
        let fixture: ComponentFixture<MedicoClinicComponent>;
        let service: MedicoClinicService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ClinicaNetTestModule],
                declarations: [MedicoClinicComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MedicoClinicComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(MedicoClinicComponent);
