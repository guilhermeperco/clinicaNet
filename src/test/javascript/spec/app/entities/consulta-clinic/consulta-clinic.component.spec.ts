...
import { ConsultaClinicComponent } from 'app/entities/consulta-clinic/consulta-clinic.component';
...
describe('Component Tests', () => {
    describe('ConsultaClinic Management Component', () => {
        let comp: ConsultaClinicComponent;
        let fixture: ComponentFixture<ConsultaClinicComponent>;
        let service: ConsultaClinicService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ClinicaNetTestModule],
                declarations: [ConsultaClinicComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ConsultaClinicComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ConsultaClinicComponent);
